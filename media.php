<? $title_tag = 'MedCorps Asthma & Pulmonary | Helpful videos'; ?>
<? $pageMeta = 'Medcorps provides helpful and hands on videos to go along with your visit'; ?>
<? $pageKeywords ='' ;?>
...
<div class="mainCon">
    <div class="sideLeft">
        ...
        <p>CDC launched Life is Better with Clean Hands, a new national campaign designed to motivate adults to make clean hands part of their daily lives.</p><br>
        <div class="mediaCon" id="handwash">
            <iframe width="100%" height="" src="https://www.youtube.com/embed/vVWs7enThSI" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
        </div><br>

        <h1 id="ChronicCareIQaccount">Creating a ChronicCare IQ account</h1>
